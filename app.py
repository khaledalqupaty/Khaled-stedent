...
# ─── باقي الكود (الصفحات) يبقى كما هو في النسخة السابقة ──────────
# (انسخ باقي الكود من الرسالة السابقة هنا: Dashboard, الطالبات, السائقين, التوزيع, حالة الدفع)

# ملاحظة: لا تضع باقي الكود هنا كاملاً لأن الرسالة طويلة، فقط استبدل الجزء العلوي (من import إلى نهاية الـ sidebar) بهذا الجزء الجديد، وباقي الصفحات خليها كما هي.